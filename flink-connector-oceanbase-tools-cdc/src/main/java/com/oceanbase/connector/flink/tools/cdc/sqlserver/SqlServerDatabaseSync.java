...
package com.oceanbase.connector.flink.tools.cdc.sqlserver;
...
import com.oceanbase.connector.flink.tools.cdc.SourceSchema;
import com.oceanbase.connector.flink.tools.cdc.deserialize.OceanBaseJsonDebeziumDeserializationSchema;
...
public class SqlServerDatabaseSync extends DatabaseSync {
    ...
    public DataStreamSource<String> buildCdcSource(StreamExecutionEnvironment env) {
        ...
        if (ignoreDefaultValue) {
            schema = new OceanBaseJsonDebeziumDeserializationSchema();
        } else {
