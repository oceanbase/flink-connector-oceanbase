...
import com.oceanbase.connector.flink.OBKVDirectLoadConnectorOptions;
...
public class OBKVDirectLoadDynamicTableSink implements DynamicTableSink {

    private final ResolvedSchema physicalSchema;
    private final OBKVDirectLoadConnectorOptions connectorOptions;
    private final RuntimeExecutionMode runtimeExecutionMode;
    private final int numberOfTaskSlots;

    public OBKVDirectLoadDynamicTableSink(
